...
class Data_analisis extends CI_Controller
{
    ...
    public function method()
    {
        ...
        if (!$arr) {
            ...
            function buatKombinasi($data_arr, &$kombinasi, $jumlahKombinasi, &$loop, $temp = [])
            {
                ...
                for ($index = 0; $index < count($data_arr); $index++) {
                    ...
                    if (count(array_unique($kombinasiBaru)) < count($kombinasiBaru)) {
                        ...
                        if ($jumlahKombinasi == 1) {
                            ...
                            // data awalnya
                            buatKombinasi($data_arr, $kombinasi, ($jumlahKombinasi - 1), $loop, $kombinasiBaru);
                        }
                    }
                }
            }
            ...
            for ($i = 0; $i < $jml_kombinasi; $i++) {
                buatKombinasi($data_arr, $kombinasi, $i + 1, $loop, array());
            }
