                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="bulan" placeholder="Bulan" value="<?php echo date("m");?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" name="pemakaian" placeholder="0" value="<?php echo set_value('pemakaian'); ?>">
