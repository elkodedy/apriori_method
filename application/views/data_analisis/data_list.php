                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="jml_obat" placeholder="Jumlah Obat" min="1" max="24" value="<?php if (isset($input_jml_obat)) echo $input_jml_obat ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-6 col-sm-3">
                                            <div class="form-group">
