                ...
                <div class="card-body">
                                    ...
                                    <select class="form-control" name="bulan">
                                        <?php 
                                            ...
                                            foreach($arrayMonth as $arr){
                                                ...
                                                } else {echo '<option value="'.$num.'">'.$arrayMonth[$num - 0].'</option>'; }
                                                $num++;
                                            }
                                        ?>
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="penerimaan" placeholder="Penerimaan" value="<?php echo $file->penerimaan; ?>">
                        ...
                        <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" name="sisa_stok" placeholder="Sisa Stok" value="<?php echo $file->sisa_stok; ?>">
